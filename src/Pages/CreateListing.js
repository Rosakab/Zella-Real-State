...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    if (images.length > 10) {
      setLoading(false);
      toast.error("The maximum number of images must be less than 10");
      return;
    }
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex">
          <button
            ...
            value="sale"
            onClick={onChange}
            className={`mr-3 px-7 py-3 font-medium text-sm  shadow-md rounded hover:shadow-lg  w-full ${
              type === "rent"
                ? "bg-white text-black"
          ...
          <button
            ...
            value="rent"
            onClick={onChange}
            className={`ml-3 px-7 py-3 font-medium text-sm  shadow-md rounded hover:shadow-lg  w-full ${
              type === "sale"
                ? "bg-white text-black"
                : "bg-slate-600 text-white"
            }`}
